...
const ContactPart = () => {
  ...
  return (
    <section className="w-full flex justify-center">
      <div className="w-full flex flex-col lg:flex-row text-center justify-center max-w-7xl">
        <div className="w-full flex flex-col gap-2 items-center py-8 lg:py-16 bg-green-50">
        ...
        <div className="w-full flex flex-col gap-2 items-center py-8 lg:py-16 bg-yellow-50 border-x-2">
        ...
        <div className="w-full flex flex-col gap-2 items-center py-8 lg:py-16 bg-violet-50">
